...
opt_rm_rhythm_first: "🥁 إيقاع ثم موسيقى",
opt_rm_balanced: "⚖️ توازن بين الموسيقى والإيقاع",
opt_rm_ambient: "🌌 أجواء هادئة بدون إيقاع",
opt_rm_cinematic: "🎬 طابع سينمائي ملحمي",
opt_rm_soft_groove: "✨ إيقاع ناعم وخفيف",
opt_rm_epic_hybrid: "🔥 مزيج شرقي حديث",
                ...
                opt_male: "صوت رجالي", opt_female: "صوت نسائي", opt_boy: "صوت طفل", opt_girl: "صوت طفلة", opt_child_choir: "كورال أطفال", opt_male_choir: "كورال رجال", opt_group: "هارموني جماعي", opt_poetry: "إلقاء شعري", opt_operatic: "صوت أوبرالي", opt_raspy: "صوت مبحوح",
                og_vocals_basic: "الأصوات الأساسية",
og_vocals_duets: "الدويتوهات",
og_vocals_pro: "الأنماط الاحترافية",
opt_duet_mf: "👫 دويتو رجالي/نسائي",
opt_duet_romantic: "💞 دويتو رومانسي",
opt_duet_rap: "🎤🎶 دويتو راب وغناء",
opt_duet_mom_child: "👩‍👦 دويتو طفل وأم",
opt_duet_shaabi: "🪘 دويتو شعبي مصري",
opt_duet_epic: "🏛️ دويتو كورال ملحمي",
opt_voc_tarab: "🎼 صوت شرقي طربي",
opt_voc_khaleeji: "🐪 صوت خليجي",
opt_voc_bedouin: "⛺ صوت بدوي",
opt_voc_shaabi: "🥁 صوت شعبي مصري",
opt_voc_rap: "🎧 صوت راب عربي",
opt_voc_intimate: "☕ صوت هادئ حميمي",
opt_voc_cinematic: "🎬 صوت درامي سينمائي",
opt_voc_angelic: "🕊️ صوت ملائكي ناعم",
opt_voc_powerful: "🔥 صوت حماسي قوي",
opt_voc_chanting: "🕌 صوت إنشادي ديني",
opt_voc_edu_kids: "📚 صوت تعليمي للأطفال",
...
opt_rm_rhythm_first: "🥁 Rhythm First",
opt_rm_balanced: "⚖️ Balanced Music & Rhythm",
opt_rm_ambient: "🌌 Ambient (No Percussion)",
opt_rm_cinematic: "🎬 Epic Cinematic",
opt_rm_soft_groove: "✨ Soft Groove",
opt_rm_epic_hybrid: "🔥 Modern Oriental Hybrid",
                ...
                og_vocals_basic: "Basic Vocals",
og_vocals_duets: "Vocal Duets",
og_vocals_pro: "Pro & Regional Styles",
opt_duet_mf: "👫 Male/Female Duet",
opt_duet_romantic: "💞 Romantic Duet",
opt_duet_rap: "🎤🎶 Rap & Singing Duet",
opt_duet_mom_child: "👩‍👦 Mother & Child Duet",
opt_duet_shaabi: "🪘 Egyptian Shaabi Duet",
opt_duet_epic: "🏛️ Epic Choir Duet",
opt_voc_tarab: "🎼 Oriental Tarab Vocal",
opt_voc_khaleeji: "🐪 Khaleeji Vocal",
opt_voc_bedouin: "⛺ Bedouin Vocal",
opt_voc_shaabi: "🥁 Egyptian Shaabi Vocal",
opt_voc_rap: "🎧 Arabic Rap Vocal",
opt_voc_intimate: "☕ Intimate Soft Vocal",
opt_voc_cinematic: "🎬 Cinematic Dramatic Vocal",
opt_voc_angelic: "🕊️ Angelic Soft Vocal",
opt_voc_powerful: "🔥 Powerful Energetic Vocal",
opt_voc_chanting: "🕌 Religious Chanting Vocal",
opt_voc_edu_kids: "📚 Educational Kids Vocal",
    ...
    // السطر ده اللي كان ممسوح وبيرجع الهيكلة صح
    const MusicEngine = (() => {
        const INTRO_LOGIC = {
            // الأنماط الأساسية
            "تلقائي (حسب اللحن)": "[Intro]",
            "سيبها للذكاء الاصطناعي": "[Auto Intro]",
            ...
            "خبطة لزق (بدون مقدمة)": "[No Intro] [Direct Start] [Sudden Entry]",
            ...
            // الإضافات الجديدة
            "مقدمة سينمائية غنائية": "[Cinematic Vocal Intro] [Epic Choir Start]",
            "مقدمة شعبية مصرية": "[Egyptian Shaabi Intro] [Mizmar and Tabla start]",
            "مقدمة أوركسترالية عربية": "[Arabic Orchestral Intro] [Grand strings start]",
            "مقدمة بيانو رومانسية": "[Romantic Piano Intro] [Soft piano solo start]",
            "مقدمة راب مباشرة": "[Direct Rap Intro] [Beat drop start] [No Intro]",
            "مقدمة إلكترونية حديثة": "[Modern Electronic Intro] [Synth buildup]",
            "مقدمة هادئة حالمة": "[Dreamy Calm Intro] [Ambient pad start]",
            "مقدمة حماسية قوية": "[Strong Enthusiastic Intro] [Powerful beat start]",
            "مقدمة دينية روحانية": "[Spiritual Religious Intro] [Ney solo] [Atmospheric start]",
            "مقدمة تعليمية مرحة": "[Fun Educational Intro] [Upbeat playful start]",
            "مقدمة أطفال كرتونية": "[Kids Cartoon Intro] [Bouncy whimsical start]",
            "مقدمة وطنية ملحمية": "[Epic Patriotic Intro] [Brass and Timpani start]"
        };
        const OUTRO_LOGIC = {
...
if (realRegisterBtn) {
    ...
    const PresetLibraryEngine = (() => {
        ...
        const songPresets = [
            ...
            { ar: "أغنية تعليمية للأطفال", en: "Educational Kids Song", data: { rhythm: "fox", feeling: "joyful", vocals: "Children Choir", tempo: "Medium", maqam: "Ajam", rhythmicMode: "Rhythmic", instrumentation: "Intro: Flute, Acoustic Guitar | Verse: Piano | Chorus: Flute, Synthesizer", trackType: "full", duration: 120 } },
            { ar: "أغنية وطنية حماسية", en: "Enthusiastic Patriotic Song", data: { rhythm: "military_march", feeling: "proud", vocals: "Group harmony", tempo: "Fast", maqam: "Rast", rhythmicMode: "Rhythmic", instrumentation: "Intro: Brass, Snare Drum | Verse: Brass | Chorus: Full Orchestra, Timpani", trackType: "full", duration: 180 } },
            { ar: "نشيد وطني رسمي", en: "Official National Anthem", data: { rhythm: "wahda_kabira", feeling: "proud", vocals: "Male Choir", tempo: "Slow", maqam: "Ajam", rhythmicMode: "Rhythmic", instrumentation: "Intro: Brass, Timpani | Verse: Full Orchestra | Chorus: Full Orchestra, Cymbals", trackType: "full", duration: 120 } },
            { ar: "أغنية دينية روحانية", en: "Spiritual Religious Song", data: { rhythm: "None", feeling: "nostalgic", vocals: "Male vocal", tempo: "Slow", maqam: "Hijaz", rhythmicMode: "Ambient", instrumentation: "Intro: Ney | Verse: Ney | Chorus: Oud", trackType: "full", duration: 180 } },
            { ar: "أنشودة إسلامية بدون إيقاعات", en: "Islamic Nasheed (No Rhythm)", data: { rhythm: "None", feeling: "uplifting", vocals: "Group harmony", tempo: "Medium", maqam: "Rast", rhythmicMode: "Ambient", instrumentation: "Intro: Group Vocal | Verse: Group Vocal | Chorus: Group Vocal", trackType: "full", duration: 180 } },
            { ar: "أغنية تحفيزية رياضية", en: "Sports Motivational Song", data: { rhythm: "fox", feeling: "powerful", vocals: "Male vocal", tempo: "Fast", maqam: "Kurd", rhythmicMode: "Rhythmic", instrumentation: "Intro: Electric Guitar, Drum Kit | Verse: Drum Kit | Chorus: Electric Guitar, Synthesizer", trackType: "full", duration: 180 } },
            { ar: "أغنية نجاح وتخرج", en: "Graduation & Success Song", data: { rhythm: "maqsum", feeling: "festive", vocals: "Group harmony", tempo: "Medium", maqam: "Ajam", rhythmicMode: "Rhythmic", instrumentation: "Intro: Trumpet, Piano | Verse: Piano | Chorus: Brass, Drum Kit", trackType: "full", duration: 180 } },
            { ar: "أغنية عيد ميلاد", en: "Birthday Song", data: { rhythm: "fox", feeling: "joyful", vocals: "Children Choir", tempo: "Fast", maqam: "Ajam", rhythmicMode: "Rhythmic", instrumentation: "Intro: Acoustic Guitar, Synthesizer | Verse: Piano | Chorus: Synthesizer, Drum Kit", trackType: "full", duration: 120 } },
            { ar: "أغنية أطفال مرحة", en: "Playful Kids Song", data: { rhythm: "malfuf", feeling: "danceable", vocals: "Young Girl vocal", tempo: "Fast", maqam: "Ajam", rhythmicMode: "Rhythmic", instrumentation: "Intro: Synthesizer, Flute | Verse: Piano | Chorus: Synthesizer, Drum Kit", trackType: "full", duration: 120 } },
            { ar: "أغنية أكشن شبابية", en: "Youth Action Song", data: { rhythm: "trap", feeling: "powerful", vocals: "Raspy Vocal", tempo: "Fast", maqam: "Kurd", rhythmicMode: "Rhythmic", instrumentation: "Intro: Electric Bass, Synthesizer | Verse: Drum Kit | Chorus: Electric Guitar, Drum Kit", trackType: "full", duration: 180 } },
            { ar: "أغنية تراث عربي", en: "Arabic Heritage Song", data: { rhythm: "samri", feeling: "nostalgic", vocals: "Male vocal", tempo: "Medium", maqam: "Sikah", rhythmicMode: "Rhythmic", instrumentation: "Intro: Oud, Qanun | Verse: Oud | Chorus: Qanun, Daf", trackType: "full", duration: 180 } },
            { ar: "موال شعبي", en: "Shaabi Mawal", data: { rhythm: "None", feeling: "sad", vocals: "Raspy Vocal", tempo: "Slow", maqam: "Bayati", rhythmicMode: "Ambient", instrumentation: "Intro: Ney, Kawala | Verse: Kawala | Chorus: Accordion", trackType: "full", duration: 180 } },
            { ar: "أغنية خليجية عصرية", en: "Modern Khaleeji Song", data: { rhythm: "pop_khaliji", feeling: "danceable", vocals: "Male vocal", tempo: "Medium", maqam: "Kurd", rhythmicMode: "Rhythmic", instrumentation: "Intro: Oud, Synthesizer | Verse: Oud | Chorus: Electric Guitar, Drum Kit", trackType: "full", duration: 180 } },
            { ar: "أغنية بدوية", en: "Bedouin Song", data: { rhythm: "samri", feeling: "proud", vocals: "Male vocal", tempo: "Medium", maqam: "Hijaz", rhythmicMode: "Rhythmic", instrumentation: "Intro: Acoustic Guitar, Daf | Verse: Acoustic Guitar | Chorus: Daf, Tabla", trackType: "full", duration: 180 } },
            { ar: "أغنية صعيدي", en: "Saidi Song", data: { rhythm: "saidi", feeling: "powerful", vocals: "Male vocal", tempo: "Fast", maqam: "Bayati", rhythmicMode: "Rhythmic", instrumentation: "Intro: Kawala, Tabla | Verse: Tabla | Chorus: Kawala, Tabla", trackType: "full", duration: 180 } },
            { ar: "أغنية أفراح شعبية مصرية", en: "Egyptian Shaabi Wedding Song", data: { rhythm: "baladi", feeling: "festive", vocals: "Male vocal", tempo: "Fast", maqam: "Bayati", rhythmicMode: "Rhythmic", instrumentation: "Intro: Accordion, Synthesizer | Verse: Tabla | Chorus: Accordion, Drum Kit", trackType: "full", duration: 180 } },
            { ar: "أغنية حزينة درامية جداً", en: "Very Sad Dramatic Song", data: { rhythm: "None", feeling: "tragic", vocals: "Female vocal", tempo: "Slow", maqam: "Saba", rhythmicMode: "Ambient", instrumentation: "Intro: Cello, Ney | Verse: Cello | Chorus: Violins", trackType: "full", duration: 180 } },
   ...
   // استبدل موديول FounderManager القديم بهذا الكود حرفياً
    const FounderManager = (() => {
        const updateUI = (data, isLoading = false) => {
            ...
            const cinematicBio = `حسين محمد سيد عبدالعال، المعروف فنياً باسم "حسين الملك"، هو شاعر غنائي وملحن ومبرمج تطبيقات موسيقة مصري من محافظة المنيا بصعيد مصر، وباحث أكاديمي بجامعة القاهرة، بالإضافة إلى كونه عازفاً لآلة الكونترباص. يجمع في مسيرته بين الحس الفني والخبرة التقنية، حيث عمل على تطوير رؤى موسيقية حديثة تمزج بين الإبداع الإنساني وتقنيات الذكاء الاصطناعي.

له عدد من المؤلفات الغنائية والموسيقية، ومؤلف لعدد من السيناريوهات السينمائية، كما قدم أحد البرامج التلفزيونية على التلفزيون المصري ، ويهتم بمجالات الموسيقى التعبيرية والعلاج بالموسيقى، مع تركيز خاص على توظيف التكنولوجيا لخدمة العملية الإبداعية وتوسيع فرص الوصول إلى الإنتاج الموسيقي.

قام بتأسيس وبرمجة منصة “Music Factory AI” بهدف إتاحة أدوات ذكية تساعد المبدعين على تحويل أفكارهم إلى أعمال موسيقية متكاملة بسهولة واحترافية، سواء كانوا شعراء، صناع محتوى، يوتيوبرز، مخرجين سينمائيين، أو منتجي وسائط رقمية يبحثون عن موسيقى تصويرية وألحان تعبّر عن رؤيتهم الفنية.`;
